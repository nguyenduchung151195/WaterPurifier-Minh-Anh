...
import audioPlayer from '../../utils/call/audioPlayer';
...
export default class Phone extends React.Component {
        ...
        <div data-component="Phone">
          <header>
            {/* <div className="topbar">
              ...
              >
                <CopyToClipboard text={invitationLink} onCopy={this.handleMenuCopyInvitationLink.bind(this)}>
                  <MenuItem primaryText="Copy invitation link" />
                </CopyToClipboard>
                <CopyToClipboard text={props.settings.uri || ''} onCopy={this.handleMenuCopyUri.bind(this)}>
                  <MenuItem primaryText="Copy my SIP URI" />
                </CopyToClipboard>
                <MenuItem primaryText="Exit" onClick={this.handleMenuExit.bind(this)} />
              </Menu>
            </div> */}
            {state.session || state.incomingSession ? null : (
              <Dialer
                {...this.props}
          ...
          <div className="content">
            ...
            {state.session ? <Session session={state.session} onNotify={props.onNotify} onHideNotification={props.onHideNotification} /> : null}
            {/* </If> */}
  ...
  componentDidMount() {
    ...
    if (settings.socket.via_transport !== 'auto') socket.via_transport = settings.socket.via_transport;
