        ...
        <div data-component="Settings">
          ...
          <List>
            <ListItem
              ...
              rightToggle={<Toggle defaultToggled={settings.session_timers} onToggle={this.handleToogleSessionTimers.bind(this)} />}
            />
            ...
            <ListItem
              ...
              secondaryTextLines={1}
              rightToggle={<Toggle defaultToggled={settings.use_preloaded_route} onToggle={this.handleToogleUsePreloadedRoute.bind(this)} />}
            />
          </List>
          ...
          <List>
            <ListItem
              ...
              secondaryTextLines={1}
              rightToggle={<Toggle defaultToggled={settings.callstats.enabled} onToggle={this.handleToogleCallstatsEnabled.bind(this)} />}
            />
          </List>
          ...
          <div className="buttons">
            <RaisedButton label="Cancel" secondary style={{ display: 'block' }} onClick={this.handleCancel.bind(this)} />

            <RaisedButton label="OK" primary style={{ display: 'block' }} onClick={this.handleSubmit.bind(this)} />
          </div>
        </div>
      </TransitionAppear>
    );
