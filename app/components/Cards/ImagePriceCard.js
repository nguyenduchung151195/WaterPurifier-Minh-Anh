...
import { Card, CardContent, CardHeader, CardActions, Typography } from '@material-ui/core';
// core components
...
class ImagePriceCard extends React.Component {
  ...
  render() {
    const { classes, image, title, text, price, statIconColor, statLink, statText, underImage, hover } = this.props;
    ...
    return (
      <Card className={classes.card} {...addHoverEvent}>
        ...
        <CardContent className={classes.cardContent}>
          {hover ? <div className={classes.underImage}>{underImage}</div> : null}
