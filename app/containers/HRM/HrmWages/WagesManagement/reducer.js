...
function wagesManagementReducer(state = initialState, action) {
  switch (action.type) {
    case MERGE_DATA:
    ...
    case CREATE_WAGES:
      return state
        .set('isLoading', true)
        .set('createWagesSuccess', null)
        .set('reload', false);
    case CREATE_WAGES_SUCCESS:
      return state
        .set('isLoading', false)
        .set('createWagesSuccess', true)
        .set('reload', true);
    case CREATE_WAGES_FAILURE:
      return state
        .set('isLoading', false)
        .set('createWagesSuccess', false)
        .set('reload', false);
    case UPDATE_WAGES:
      return state
        .set('isLoading', true)
        .set('updateWagesSuccess', null)
        .set('reload', false);
    case UPDATE_WAGES_SUCCESS:
      return state
        .set('isLoading', false)
        .set('updateWagesSuccess', true)
        .set('reload', true);
    case UPDATE_WAGES_FAILURE:
      return state
        .set('isLoading', false)
        .set('updateWagesSuccess', false)
        .set('reload', false);
    case DELETE_WAGES:
      return state
        .set('isLoading', true)
        .set('deleteWagesSuccess', null)
        .set('reload', false);
    case DELETE_WAGES_SUCCESS:
      return state
        .set('isLoading', false)
        .set('deleteWagesSuccess', true)
        .set('reload', true);
    case DELETE_WAGES_FAILURE:
      return state
        .set('isLoading', false)
        .set('deleteWagesSuccess', false)
        .set('reload', false);
...
export default wagesManagementReducer;
