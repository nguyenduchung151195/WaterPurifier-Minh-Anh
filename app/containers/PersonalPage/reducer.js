...
function personalPageReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GET_IS_USER_FOLLOWED_SUCCESS:
      return state.set('isFollowed', action.data);
    case PUT_USER_FOLLOW_SUCCESS:
      return state.set('isFollowed', action.data);
    case GET_LIST_FOLLOW_SUGGEST_SUCCESS:
      return state.set('listFollowSuggest', action.data);
    case GET_SEND_ADD_FRIEND_SUCCESS:
      return state.set('listSendAddFriend', action.data);
    case GET_LIST_FRIEND_SUCCESS:
      return state.set('listFriend', action.data);
    case GET_RELATIONSHIP_SUCCESS:
      return state.set('relationship', action.data);
