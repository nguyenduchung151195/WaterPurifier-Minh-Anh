  ...
  return (
    <React.Fragment>
      {open ? (
        ...
        <div id="reportsHrmAboutExpireCotract" style={{ display: 'none' }}>
          <table>
            <tbody>
              <tr>
            ...
            <tbody>
              {data.map((item, index) => (
                <tr>
                  ...
                  <td>{item.contractStartDate ? moment(item.contractStartDate).format('DD/MM/YYYY') : ''}</td>
                  <td>{item.contractEndDate ? moment(item.contractEndDate).format('DD/MM/YYYY') : ''}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
