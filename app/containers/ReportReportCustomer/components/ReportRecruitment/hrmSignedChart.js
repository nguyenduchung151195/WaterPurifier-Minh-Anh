...
function createChart(id, data) {
  ...
  title.text = 'BÁO CÁO TỔNG HỢP SỐ LƯỢNG HỒ SƠ TUYỂN DỤNG';
  title.fontSize = 19;
  ...
  const categoryAxis1 = chart.yAxes.push(new am4charts.CategoryAxis());
  categoryAxis1.renderer.grid.template.location = 0;
  categoryAxis1.dataFields.category = 'name1';
